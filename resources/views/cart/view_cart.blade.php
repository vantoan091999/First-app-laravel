    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <table class="table shopping-summery cart-change">
                ...
                <tr>
                    {{-- <td><button onclick="removeCart({{$cart['id']}})">X</button></td> --}}
                    <td class="image" data-title="No"><img width="100px" src="{{asset('image/'.$cart['productImage'])}}" alt="#"></td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-7 col-12" id="sub" >
                        <div class="right sub-change" >
                            <ul>
                                <li><h4 >Thành tiền: <span>@php echo number_format($subtotal,0,',','.'); @endphp Đ</span></h4></li>
                                <li>Vận chuyển<span>Free</span></li>
                                <!--                                    <li>You Save<span>$20.00</span></li>-->Tổng: &emsp; &emsp; <span style="color: red;font-size: 30px;font-weight: bold">@php echo number_format($subtotal,0,',','.'); @endphp Đ</span>
                                <li class="last"></li>
                            </ul>
                            {{-- <div class="button5">
                                <div class="row">
